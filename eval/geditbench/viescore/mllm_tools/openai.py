'''
python3 eval/geditbench/viescore/mllm_tools/openai.py
'''
import base64
import requests
...
class GPT4v():
    def __init__(self, api_key_path='keys/secret.env', are_images_encoded=False, model_name="gpt-4-vision-preview"):
        ...
        self.url = "https://search-va.byteintl.net/gpt/openapi/online/multimodal/crawl"
...
if __name__ == "__main__":
    model = GPT4v('', model_name='gpt-4.1')
    ...
    print("result : \n", res)
    # res2 = model.extract_response(res)